...
**Q2: Count Digits**  
Recursively count the number of digits in a positive integer without using string conversion.

**Q3: Binary Search on Score Array**  
Perform binary search on a sorted array to find a target score and return its index.

**Q4: First Occurrence (Binary Search)**  
...
Find total occurrences of a target in a sorted array using binary search only.
